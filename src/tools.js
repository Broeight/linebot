...
const defs = [
  ...
  },
  {
    ...
    function: {
      name: 'web_search',
      description:
        '上網搜尋「最新／即時、會隨時間改變」的資訊並取得帶來源的摘要。只在需要當前資訊時呼叫：' +
        '今天的新聞時事、最近剛發生的事件、目前股價/匯率/商品行情、賽事比分、剛上市或剛發布的消息。' +
        '不要用於：一般知識、醫藥或健康常識、產品或人物的一般介紹、生活建議、推薦、閒聊、打招呼、' +
        '創意寫作、翻譯，以及已有專屬工具的查詢（天氣、台鐵、匯率、油價、台灣假日、加油站、發票對獎、' +
        '提醒、記帳）——這些一律直接用既有知識或對應工具回答，不要搜尋。',
      parameters: {
        type: 'object',
        properties: {
          query: {
...
function timeContext() {
  ...
  return (
    ...
    '只有在需要「最新／即時資訊」時（今天的新聞時事、最近剛發生的事、目前股價匯率行情、賽事比分等會隨時間改變的事實）' +
      '才呼叫 web_search 工具搜尋再回答；一般知識、醫藥/健康常識、推薦、閒聊、翻譯、創意內容都不要搜尋，直接回答。' +
